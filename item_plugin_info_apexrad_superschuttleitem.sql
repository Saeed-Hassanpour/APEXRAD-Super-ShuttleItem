...
'        l_disps     apex_application_global.vc_arr2;',
'        l_merge_sql varchar2(32767);',
'        l_flags     apex_application_global.vc_arr2;',
'        l_idx       pls_integer := 0;',
'      begin',
'        -- Collect current collection into arrays (ordered: NEW first)',
'        for rec in (select c001, c002 from apex_collections',
'                     where collection_name = l_coll',
'                     order by case when c003=''NEW'' then 0 else 1 end, seq_id) loop',
'          l_idx := l_idx + 1;',
'          l_ids(l_idx)   := rec.c001;',
'          l_disps(l_idx) := rec.c002;',
'          l_flags(l_idx) := ''SAVED'';',
'        end loop;',
...
'            l_merge_sql  varchar2(32767);',
'            l_del_sql    varchar2(4000);',
'          begin',
'            -- Check collection member count',
'            if apex_collection.collection_exists(l_coll) then',
'              select count(*) into l_coll_count',
'                from apex_collections',
'               where collection_name = l_coll;',
'            end if;',
'            if l_coll_count = 0 then',
'              -- Collection empty or missing: DELETE all rows from target',
'              -- (user removed everything from right panel)',
'              execute immediate ''delete from ''||l_safe_tbl',
'                ||case when l_where_clause is not null',
'                     then '' where (''||l_where_clause||'')'' else '''' end;',
'            else',
'              -- Collection has members: MERGE then DELETE deselected rows',
'              l_merge_sql := ''merge into ''||l_safe_tbl||'' tgt'';',
'              l_merge_sql := l_merge_sql||'' using (select c001 src_val from apex_collections'';',
'              l_merge_sql := l_merge_sql||''  where collection_name=''||chr(39)||l_coll||chr(39)||'') src'';',
'              l_merge_sql := l_merge_sql||'' on (tgt.''||l_safe_col||''=src.src_val)'';',
'              l_merge_sql := l_merge_sql||'' when not matched then insert (''||l_safe_col||'')'';',
'              l_merge_sql := l_merge_sql||'' values (src.src_val)'';',
'              execute immediate l_merge_sql;',
'              -- Delete rows no longer in collection (deselected by user)',
'              l_del_sql := ''delete from ''||l_safe_tbl||'' tgt2 where not exists'';',
'              l_del_sql := l_del_sql||'' (select 1 from apex_collections ac'';',
'              l_del_sql := l_del_sql||''  where ac.collection_name=''||chr(39)||l_coll||chr(39)||''  and ac.c001=tgt2.''||l_safe_col||'')'';',
'              execute immediate l_del_sql;',
'            end if;',
'          exception when others then',
'            apex_debug.error(''APEXRAD SSI SAVE MERGE: ''||sqlerrm);',
'            raise;',
'          end;',
'        else',
'          -- DELETE + INSERT (original behaviour)',
'          -- Single SQL: INSERT INTO target SELECT from collection (no row-by-row loop)',
'          execute immediate ''delete from ''||l_safe_tbl',
'            ||case when l_where_clause is not null',
'                 then '' where (''||l_where_clause||'')'' else '''' end;',
'          declare',
'            l_ins_sql varchar2(4000);',
'          begin',
'            l_ins_sql := ''insert into ''||l_safe_tbl||'' (''||l_safe_col||'')'';',
'            l_ins_sql := l_ins_sql||'' select c001 from apex_collections where collection_name=''||chr(39)||l_coll||chr(39);',
'            execute immediate l_ins_sql;',
'          end;',
'        end if;',
'        -- Collection rebuild handled by _loadSaved() after save',
'        -- Just delete the collection so _loadSaved rebuilds fresh from DB',
'        if apex_collection.collection_exists(l_coll) then',
'          apex_collection.delete_collection(l_coll);',
'        end if;',
'        apex_json.write(''saved'', l_idx);',
'      exception when others then',
...
wwv_flow_imp.g_varchar2_table(68) := '';
wwv_flow_imp.g_varchar2_table(69) := '';
wwv_flow_imp.g_varchar2_table(70) := '';
wwv_flow_imp.g_varchar2_table(71) := '';
wwv_flow_imp.g_varchar2_table(72) := '';
wwv_flow_imp.g_varchar2_table(73) := '';
wwv_flow_imp.g_varchar2_table(74) := '';
wwv_flow_imp.g_varchar2_table(75) := '';
wwv_flow_imp.g_varchar2_table(76) := '';
wwv_flow_imp.g_varchar2_table(77) := '';
wwv_flow_imp.g_varchar2_table(78) := '';
wwv_flow_imp.g_varchar2_table(79) := '';
wwv_flow_imp.g_varchar2_table(80) := '';
wwv_flow_imp.g_varchar2_table(81) := '';
wwv_flow_imp.g_varchar2_table(82) := '';
wwv_flow_imp.g_varchar2_table(83) := '';
wwv_flow_imp.g_varchar2_table(84) := '';
wwv_flow_imp.g_varchar2_table(85) := '';
wwv_flow_imp.g_varchar2_table(86) := '';
wwv_flow_imp.g_varchar2_table(87) := '';
wwv_flow_imp.g_varchar2_table(88) := '';
wwv_flow_imp.g_varchar2_table(89) := '';
wwv_flow_imp.g_varchar2_table(90) := '';
wwv_flow_imp.g_varchar2_table(91) := '';
wwv_flow_imp.g_varchar2_table(92) := '';
wwv_flow_imp.g_varchar2_table(93) := '';
wwv_flow_imp.g_varchar2_table(94) := '';
wwv_flow_imp.g_varchar2_table(95) := '';
wwv_flow_imp.g_varchar2_table(96) := '';
wwv_flow_imp.g_varchar2_table(97) := '';
wwv_flow_imp.g_varchar2_table(98) := '';
wwv_flow_imp.g_varchar2_table(99) := '';
wwv_flow_imp.g_varchar2_table(100) := '';
wwv_flow_imp.g_varchar2_table(101) := '';
wwv_flow_imp.g_varchar2_table(102) := '';
wwv_flow_imp.g_varchar2_table(103) := '';
wwv_flow_imp.g_varchar2_table(104) := '';
wwv_flow_imp.g_varchar2_table(105) := '';
wwv_flow_imp.g_varchar2_table(106) := '';
wwv_flow_imp.g_varchar2_table(107) := '';
wwv_flow_imp.g_varchar2_table(108) := '';
wwv_flow_imp.g_varchar2_table(109) := '';
wwv_flow_imp.g_varchar2_table(110) := '';
wwv_flow_imp.g_varchar2_table(111) := '';
wwv_flow_imp.g_varchar2_table(112) := '';
wwv_flow_imp.g_varchar2_table(113) := '';
wwv_flow_imp.g_varchar2_table(114) := '';
wwv_flow_imp.g_varchar2_table(115) := '';
wwv_flow_imp.g_varchar2_table(116) := '';
wwv_flow_imp.g_varchar2_table(117) := '';
wwv_flow_imp.g_varchar2_table(118) := '';
wwv_flow_imp.g_varchar2_table(119) := '';
wwv_flow_imp.g_varchar2_table(120) := '';
wwv_flow_imp.g_varchar2_table(121) := '';
wwv_flow_imp.g_varchar2_table(122) := '';
wwv_flow_imp.g_varchar2_table(123) := '';
wwv_flow_imp.g_varchar2_table(124) := '';
wwv_flow_imp.g_varchar2_table(125) := '';
wwv_flow_imp.g_varchar2_table(126) := '6F6164536176656428293B0A0A20202020202020207D202F2F20696E69740A202020207D3B202F2F20617065787261642E737570657253687574746C654974656D0A0A7D28617065782E6A51756572792C206170657829293B0A';
end;
/
begin
...
,p_prompt=>'Use MERGE Statement'
,p_attribute_type=>'CHECKBOX'
,p_is_required=>false
,p_default_value=>'Y'
,p_is_translatable=>false
,p_help_text=>'When Yes (default), SAVE uses MERGE INTO the target table: inserts new rows (WHEN NOT MATCHED) then deletes rows no longer in the right panel (DELETE WHERE FK NOT IN collection). When No: deletes all rows then re-inserts. '
);
end;
/
